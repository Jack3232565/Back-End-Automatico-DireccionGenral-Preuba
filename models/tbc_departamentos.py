...
class Departamento(Base):
    ...
    personal_medico = relationship("TbbPersonalMedico", back_populates="departamento")
    area_medica = relationship("TbcAreasMedica", back_populates="departamentos")
